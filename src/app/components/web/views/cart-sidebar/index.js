                ...
                <div className="cart-sidebar">
                            ...
                            cartItems.map((row, index) => (
                                <div className="cart-item" key={index}>
                                    <div className="cart-product-img">
                                        <img className="img-fluid" src={row.filename} alt="cart" />
                                        <div className="offer-badge">{row.rating}</div>
                                    </div>
                                    <div className="cart-text">
                                        ...
                                        <div className="qty-group">
                                            ...
                                            <div className="cart-item-price">&#x20B9;{(row.qty * row.price).toFixed(2)}</div>
                                        </div>
                    ...
                    <div className="cart-sidebar-footer">
                        <div className="cart-store-details">
                            ...
                            <p>Delivery Charges <strong className="float-right text-danger">+ &#x20B9;0.00</strong></p>
                            <h6>Your total savings <strong className="float-right text-danger">&#x20B9; 0.00</strong></h6>
                        </div>
