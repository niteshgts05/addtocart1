...
const Category =({categoryImg, categoryData}) => {
    // render() {
        var settings = {
            dots: false,
            infinite: false,
            ...
            <div style={{ background: '#fff' }}>
                <div className="container" id="header-category-bk">
                    <Slider {...settings}>
                        ...
                        {/* //////////////////////// */}
                        {/* console.log(data[0].category_image[0].data_url); */}

                        {categoryImg.src.length > 0 &&
          categoryImg.src.map((value, key) => (
            <div className="item" key={key}>
            <div className="category-item">
                <Link to={{
                    pathname: `/shop/grocery-staples`,
                }}>
                    <img className="img-fluid" src={value} alt="grocery-stamples" />
